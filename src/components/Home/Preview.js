...
const Preview = ({ onPressOne, onPressTwo, classFinal, yourShopping }) => {
    return (
        <View style={styles.container}>
            ...
            <View style={styles.sectionInfo}>
                <View style={styles.progress}>
                    <MyAppText fontSize={(height < 600) ? (16 * 0.8) : 16} color={'white'}>Clases finalizadas</MyAppText>
                    <MyHeaderText fontSize={(height < 600) ? (20 * 0.8) : 20} color={'white'}>{classFinal}</MyHeaderText>
                    <TouchableOpacity
                        activeOpacity={0.6}
                        onPress={onPressOne}
